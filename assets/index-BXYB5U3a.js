...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        `}),rt.jsxs("header",{className:"mb-6 md:mb-8",children:[rt.jsxs("div",{className:"flex flex-col md:flex-row md:items-end md:justify-between gap-4",children:[rt.jsxs("div",{children:[rt.jsx("h1",{className:"text-3xl md:text-4xl font-extrabold tracking-tight text-white",children:rt.jsx($e,{children:"Interactive Gate Visualization"})}),rt.jsx("p",{className:"text-base md:text-lg text-slate-400 mt-2",children:rt.jsx($e,{children:"Visualize how a qubit's state vector is transformed."})})]}),rt.jsxs("div",{className:"flex items-center gap-2",children:[rt.jsx("button",{className:"btn",onClick:A,children:"Reset"}),rt.jsx("button",{className:"btn",onClick:E,children:"Randomize"})]})]}),rt.jsx("div",{className:"sr-only","aria-live":"polite",children:h})]}),rt.jsxs("div",{className:"grid grid-cols-1 xl:grid-cols-[360px_1fr] gap-6 max-w-screen-2xl mx-auto",children:[rt.jsxs("aside",{className:"xl:sticky xl:top-6 h-max space-y-6",children:[rt.jsx(S1,{init:l,setInit:c,presets:m,onPreset:S}),rt.jsx(y1,{gate:i,setGate:s,angleUnit:r,setAngleUnit:t,setStatus:d})]}),rt.jsxs("main",{className:"space-y-6",children:[rt.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:[rt.jsxs("section",{className:"panel flex flex-col gap-3 items-center",children:[rt.jsxs("div",{className:"panel-header justify-between w-full",children:[rt.jsx("h3",{className:"text-xl text-white",children:rt.jsx($e,{children:String.raw`Initial State: $(|\psi\rangle)$`})}),rt.jsxs("div",{className:"text-xs text-slate-400",children:["|α|², |β|²:",rt.jsx("span",{className:"font-mono text-slate-300 ml-1",children:G0(p,v)})]})]}),rt.jsx(q0,{alpha:p,beta:v,vectorColor:16498468})]}),rt.jsxs("section",{className:"panel flex flex-col gap-3 items-center",children:[rt.jsxs("div",{className:"panel-header justify-between w-full",children:[rt.jsx("h3",{className:"text-xl text-white",children:rt.jsx($e,{dynamic:!0,children:`Final State: $${x?.nameLatex??i.type} |\\psi\\rangle$`})}),rt.jsxs("div",{className:"text-xs text-slate-400",children:["|α'|², |β'|²:",rt.jsx("span",{className:"font-mono text-slate-300 ml-1",children:G0(_.finalAlpha,_.finalBeta)})]})]}),rt.jsx(q0,{alpha:_.finalAlpha,beta:_.finalBeta,vectorColor:4906624})]})]}),rt.jsx("section",{className:"panel",children:rt.jsxs("details",{className:"group",open:!0,children:[rt.jsxs("summary",{className:"cursor-pointer select-none list-none flex items-center justify-between",children:[rt.jsx("h3",{className:"text-xl font-extrabold text-white",children:"3) Final State Calculation"}),rt.jsx("span",{className:"text-slate-400 text-sm",children:"(click to collapse)"})]}),rt.jsxs("div",{className:"mt-4 flex flex-col items-center gap-4",children:[rt.jsxs("div",{className:"w-full",children:[rt.jsx("p",{className:"text-center font-mono text-lg mb-2 text-indigo-400 min-h-8",children:rt.jsx($e,{dynamic:!0,children:x?.alphaEq??String.raw`\(\alpha' = (m_{00})\alpha + (m_{01})\beta\)`})}),rt.jsxs("div",{className:"flex items-center justify-center gap-3 flex-wrap p-1",children:[rt.jsx("div",{className:"w-16 text-center font-mono text-xl text-slate-400 flex items-center justify-center",children:rt.jsx($e,{children:String.raw`$|0\rangle$`})}),rt.jsxs("div",{className:"text-center",children:[rt.jsx("p",{className:"font-mono text-xs",children:"Initial α"}),rt.jsx(Wa,{vector:p,color:"#818cf8"})]}),rt.jsx("span",{className:"op-symbol",children:"→"}),rt.jsxs("div",{className:"text-center",children:[rt.jsx("p",{className:"font-mono text-xs min-h-4",children:rt.jsx($e,{dynamic:!0,children:x?.alphaTerm1??String.raw`\((m_{00})\alpha\)`})}),rt.jsx(Wa,{vector:_.a1,color:"#a5b4fc"})]}),rt.jsx("span",{className:"op-symbol",children:"+"}),rt.jsxs("div",{className:"text-center",children:[rt.jsx("p",{className:"font-mono text-xs min-h-4",children:rt.jsx($e,{dynamic:!0,children:x?.alphaTerm2??String.raw`\((m_{01})\beta\)`})}),rt.jsx(Wa,{vector:_.a2,color:"#a5b4fc"})]}),rt.jsx("span",{className:"op-symbol",children:"="}),rt.jsxs("div",{className:"text-center",children:[rt.jsx("p",{className:"font-mono text-xs",children:rt.jsx($e,{children:String.raw`$\alpha'$`})}),rt.jsx(Wa,{vector:_.finalAlpha,color:"#6366f1"})]})]})]}),rt.jsxs("div",{className:"w-full",children:[rt.jsx("p",{className:"text-center font-mono text-lg mb-2 text-teal-400 min-h-8",children:rt.jsx($e,{dynamic:!0,children:x?.betaEq??String.raw`\(\beta' = (m_{10})\alpha + (m_{11})\beta\)`})}),rt.jsxs("div",{className:"flex items-center justify-center gap-3 flex-wrap p-1",children:[rt.jsx("div",{className:"w-16 text-center font-mono text-xl text-slate-400 flex items-center justify-center",children:rt.jsx($e,{children:String.raw`$|1\rangle$`})}),rt.jsxs("div",{className:"text-center",children:[rt.jsx("p",{className:"font-mono text-xs",children:"Initial β"}),rt.jsx(Wa,{vector:v,color:"#2dd4bf"})]}),rt.jsx("span",{className:"op-symbol",children:"→"}),rt.jsxs("div",{className:"text-center",children:[rt.jsx("p",{className:"font-mono text-xs min-h-4",children:rt.jsx($e,{dynamic:!0,children:x?.betaTerm1??String.raw`\((m_{10})\alpha\)`})}),rt.jsx(Wa,{vector:_.b1,color:"#5eead4"})]}),rt.jsx("span",{className:"op-symbol",children:"+"}),rt.jsxs("div",{className:"text-center",children:[rt.jsx("p",{className:"font-mono text-xs min-h-4",children:rt.jsx($e,{dynamic:!0,children:x?.betaTerm2??String.raw`\((m_{11})\beta\)`})}),rt.jsx(Wa,{vector:_.b2,color:"#5eead4"})]}),rt.jsx("span",{className:"op-symbol",children:"="}),rt.jsxs("div",{className:"text-center",children:[rt.jsx("p",{className:"font-mono text-xs",children:rt.jsx($e,{children:String.raw`$\beta'$`})}),rt.jsx(Wa,{vector:_.finalBeta,color:"#14b8a6"})]})]})]})]})]})})]})]})]})})}const b1={loader:{load:["input/tex","output/chtml"]},tex:{inlineMath:[["$","$"],["\\(","\\)"]],displayMath:[["$$","$$"],["\\[","\\]"]]}};GS.createRoot(document.getElementById("root")).render(rt.jsx(Vd.StrictMode,{children:rt.jsx(j0,{version:3,config:b1,children:rt.jsx(E1,{})})}));
